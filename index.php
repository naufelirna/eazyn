...
var_dump($sql); //tips cek isi variabel (debugging)
?>
      ...
      <div>
        <div class="brand-logo d-flex align-items-center justify-content-between">
          <a href="./index.php" class="text-nowrap logo-img">
            <img src="assets/images/logos/logo.png" width="130" alt="" />
          </a>
    ...
    <div class="body-wrapper">
      ...
      <div class="container-fluid">
              ...
              <div class="card-body p-4">
                ...
                <div class="table-responsive">
                  <table class="table text-nowrap mb-0 align-middle">
                    ...
                    <tbody>
                    <?php
                        $fetch_data = mysqli_fetch_all($sql, MYSQLI_BOTH);
                          ...
                          <div class="d-flex align-items-center gap-2">
                            <?php
                              if($data["is_approved"]==0){
                                ...
                                ?>
                                <span class="badge bg-warning rounded-3 fw-semibold">Divalidasi</span>
                                <?php
        ...
        <!-- <div class="py-6 px-6 text-center">
          <p class="mb-0 fs-4">Copyright SIJA Stembayo @2024</p>
        </div> -->
      </div>
    </div>
  </div>
