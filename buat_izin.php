      ...
      <div>
        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
          <ul id="sidebarnav">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="index copy.html" aria-expanded="false">
                <span>
      ...
      <div class="container-fluid">
        <div class="container-fluid">
                  ...
                  <form>
                    <div class="mb-3">
                      ...
                      <select class="form-select" aria-label="Default select example" name="guru_id">
                        ...
                        <option value="6">Catarina Setyawati Marsina</option>
                      </select>
                    </div>
                    <div class="mb-3">
          ...
          <div class="py-6 px-6 text-center">
            <!-- <p class="mb-0 fs-4">Copyright SIJA B Stembayo @2024</p> -->
          </div>
        </div>
      </div>
    </div>
